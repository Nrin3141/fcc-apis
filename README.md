...
You can navigate the different projects by going to the main entry point for the site at apis.ricotrebeljahr.de and selecting the api you like. 

If you want to clone and use this repository on your own machine simply clone it via git commands and then npm install, populate the .env.example with your own values for a mongo at mlab or similar and then you are good to go. Simply npm start to start the server at localhost://3000
